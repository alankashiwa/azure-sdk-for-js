...
import {
  WeatherClientOptionalParams,
  JsonFormat,
  WeatherClientGetHourlyForecastOptionalParams,
  WeatherClientGetHourlyForecastResponse,
  WeatherClientGetMinuteForecastOptionalParams,
  WeatherClientGetMinuteForecastResponse,
  WeatherClientGetQuarterDayForecastOptionalParams,
  WeatherClientGetQuarterDayForecastResponse,
  WeatherClientGetCurrentConditionsOptionalParams,
  WeatherClientGetCurrentConditionsResponse,
  WeatherClientGetDailyForecastOptionalParams,
  WeatherClientGetDailyForecastResponse,
  WeatherClientGetWeatherAlongRouteOptionalParams,
  WeatherClientGetWeatherAlongRouteResponse,
  WeatherClientGetSevereWeatherAlertsOptionalParams,
  WeatherClientGetSevereWeatherAlertsResponse,
  WeatherClientGetDailyIndicesOptionalParams,
  WeatherClientGetDailyIndicesResponse
} from "./models";
...
export class WeatherClient extends WeatherClientContext {
   ...
   * @param coordinates The applicable query specified as a comma separated string composed by latitude
  ...
  getHourlyForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetHourlyForecastOptionalParams
  ): Promise<WeatherClientGetHourlyForecastResponse> {
  ...
  getMinuteForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetMinuteForecastOptionalParams
  ): Promise<WeatherClientGetMinuteForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getQuarterDayForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetQuarterDayForecastOptionalParams
  ): Promise<WeatherClientGetQuarterDayForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getCurrentConditions(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetCurrentConditionsOptionalParams
  ): Promise<WeatherClientGetCurrentConditionsResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getDailyForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetDailyForecastOptionalParams
  ): Promise<WeatherClientGetDailyForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getWeatherAlongRoute(
    format: JsonFormat,
    query: string,
    options?: WeatherClientGetWeatherAlongRouteOptionalParams
  ): Promise<WeatherClientGetWeatherAlongRouteResponse> {
    return this.sendOperationRequest({ format, query, options }, getWeatherAlongRouteOperationSpec);
  }
  ...
  getSevereWeatherAlerts(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetSevereWeatherAlertsOptionalParams
  ): Promise<WeatherClientGetSevereWeatherAlertsResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getDailyIndices(
    format: JsonFormat,
    coordinates: number[],
    options?: WeatherClientGetDailyIndicesOptionalParams
  ): Promise<WeatherClientGetDailyIndicesResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
...
const getWeatherAlongRouteOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion, Parameters.language, Parameters.query],
  urlParameters: [Parameters.$host, Parameters.format],
  headerParameters: [Parameters.accept, Parameters.clientId],
  serializer
};

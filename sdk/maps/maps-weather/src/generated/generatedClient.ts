...
import {
  ...
  JsonFormat,
  GeneratedClientGetHourlyForecastOptionalParams,
  GeneratedClientGetHourlyForecastResponse,
  GeneratedClientGetMinuteForecastOptionalParams,
  GeneratedClientGetMinuteForecastResponse,
  GeneratedClientGetQuarterDayForecastOptionalParams,
  GeneratedClientGetQuarterDayForecastResponse,
  GeneratedClientGetCurrentConditionsOptionalParams,
  GeneratedClientGetCurrentConditionsResponse,
  GeneratedClientGetDailyForecastOptionalParams,
  GeneratedClientGetDailyForecastResponse,
  GeneratedClientGetWeatherAlongRouteOptionalParams,
  GeneratedClientGetWeatherAlongRouteResponse,
  GeneratedClientGetSevereWeatherAlertsOptionalParams,
  GeneratedClientGetSevereWeatherAlertsResponse,
  GeneratedClientGetDailyIndicesOptionalParams,
  GeneratedClientGetDailyIndicesResponse
} from "./models";
...
export class GeneratedClient extends GeneratedClientContext {
  ...
  getHourlyForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetHourlyForecastOptionalParams
  ): Promise<GeneratedClientGetHourlyForecastResponse> {
  ...
  getMinuteForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetMinuteForecastOptionalParams
  ): Promise<GeneratedClientGetMinuteForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getQuarterDayForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetQuarterDayForecastOptionalParams
  ): Promise<GeneratedClientGetQuarterDayForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getCurrentConditions(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetCurrentConditionsOptionalParams
  ): Promise<GeneratedClientGetCurrentConditionsResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getDailyForecast(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetDailyForecastOptionalParams
  ): Promise<GeneratedClientGetDailyForecastResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getWeatherAlongRoute(
    format: JsonFormat,
    query: string,
    options?: GeneratedClientGetWeatherAlongRouteOptionalParams
  ): Promise<GeneratedClientGetWeatherAlongRouteResponse> {
    return this.sendOperationRequest(
  ...
  getSevereWeatherAlerts(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetSevereWeatherAlertsOptionalParams
  ): Promise<GeneratedClientGetSevereWeatherAlertsResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },
  ...
  getDailyIndices(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetDailyIndicesOptionalParams
  ): Promise<GeneratedClientGetDailyIndicesResponse> {
    return this.sendOperationRequest(
      { format, coordinates, options },

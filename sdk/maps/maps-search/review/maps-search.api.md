...
export interface Search {
    beginFuzzySearchBatch(format: JsonFormat, batchRequest: BatchRequest, options?: SearchFuzzySearchBatchOptionalParams): Promise<PollerLike<PollOperationState<SearchFuzzySearchBatchResponse>, SearchFuzzySearchBatchResponse>>;
    beginFuzzySearchBatchAndWait(format: JsonFormat, batchRequest: BatchRequest, options?: SearchFuzzySearchBatchOptionalParams): Promise<SearchFuzzySearchBatchResponse>;
    ...
    beginReverseSearchAddressBatch(format: JsonFormat, batchRequest: BatchRequest, options?: SearchReverseSearchAddressBatchOptionalParams): Promise<PollerLike<PollOperationState<SearchReverseSearchAddressBatchResponse>, SearchReverseSearchAddressBatchResponse>>;
    beginReverseSearchAddressBatchAndWait(format: JsonFormat, batchRequest: BatchRequest, options?: SearchReverseSearchAddressBatchOptionalParams): Promise<SearchReverseSearchAddressBatchResponse>;
    beginSearchAddressBatch(format: JsonFormat, batchRequest: BatchRequest, options?: SearchSearchAddressBatchOptionalParams): Promise<PollerLike<PollOperationState<SearchSearchAddressBatchResponse>, SearchSearchAddressBatchResponse>>;
    beginSearchAddressBatchAndWait(format: JsonFormat, batchRequest: BatchRequest, options?: SearchSearchAddressBatchOptionalParams): Promise<SearchSearchAddressBatchResponse>;
    fuzzySearch(format: ResponseFormat, query: string, options?: SearchFuzzySearchOptionalParams): Promise<SearchFuzzySearchResponse>;
    fuzzySearchBatchSync(format: JsonFormat, batchRequest: BatchRequest, options?: SearchFuzzySearchBatchSyncOptionalParams): Promise<SearchFuzzySearchBatchSyncResponse>;
    ...
    listPolygons(format: JsonFormat, geometryIds: string[], options?: SearchListPolygonsOptionalParams): Promise<SearchListPolygonsResponse>;
    ...
    reverseSearchAddressBatchSync(format: JsonFormat, batchRequest: BatchRequest, options?: SearchReverseSearchAddressBatchSyncOptionalParams): Promise<SearchReverseSearchAddressBatchSyncResponse>;
    ...
    searchAddressBatchSync(format: JsonFormat, batchRequest: BatchRequest, options?: SearchSearchAddressBatchSyncOptionalParams): Promise<SearchSearchAddressBatchSyncResponse>;
    ...
    searchStructuredAddress(format: ResponseFormat, countryCode: string, options?: SearchSearchStructuredAddressOptionalParams): Promise<SearchSearchStructuredAddressResponse>;
}
...
// @public
export interface SearchListPolygonsOptionalParams extends coreClient.OperationOptions {
}

...
export class SearchImpl implements Search {
  ...
  fuzzySearch(
    ...
    return this.client.sendOperationRequest({ format, query, options }, fuzzySearchOperationSpec);
  }
  ...
  searchAddress(
    ...
    return this.client.sendOperationRequest({ format, query, options }, searchAddressOperationSpec);
  }
  ...
  async beginFuzzySearchBatch(
    ...
    PollerLike<PollOperationState<SearchFuzzySearchBatchResponse>, SearchFuzzySearchBatchResponse>
  > {
  ...
  async beginFuzzySearchBatchAndWait(
    ...
    const poller = await this.beginFuzzySearchBatch(format, batchRequest, options);
   ...
   * @param options The options parameters.
   */
  async beginGetFuzzySearchBatch(
    batchId: string,
    options?: SearchGetFuzzySearchBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchGetFuzzySearchBatchResponse>,
      SearchGetFuzzySearchBatchResponse
    >
  > {
    const directSendOperation = async (
    ...
    const lro = new LroImpl(sendOperation, { batchId, options }, getFuzzySearchBatchOperationSpec);
    return new LroEngine(lro, {
      resumeFrom: options?.resumeFrom,
      intervalInMs: options?.updateIntervalInMs,
   ...
   * @param options The options parameters.
   */
  async beginGetFuzzySearchBatchAndWait(
    batchId: string,
    options?: SearchGetFuzzySearchBatchOptionalParams
  ): Promise<SearchGetFuzzySearchBatchResponse> {
    const poller = await this.beginGetFuzzySearchBatch(batchId, options);
    return poller.pollUntilDone();
  }
  ...
  async beginSearchAddressBatch(
    ...
    PollerLike<
      PollOperationState<SearchSearchAddressBatchResponse>,
      SearchSearchAddressBatchResponse
    >
  > {
    const directSendOperation = async (
  ...
  async beginSearchAddressBatchAndWait(
    ...
    const poller = await this.beginSearchAddressBatch(format, batchRequest, options);
    return poller.pollUntilDone();
  }
   ...
   * @param options The options parameters.
   */
  async beginGetSearchAddressBatch(
    batchId: string,
    options?: SearchGetSearchAddressBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchGetSearchAddressBatchResponse>,
      SearchGetSearchAddressBatchResponse
    >
  > {
    const directSendOperation = async (
   ...
   * @param options The options parameters.
   */
  async beginGetSearchAddressBatchAndWait(
    batchId: string,
    options?: SearchGetSearchAddressBatchOptionalParams
  ): Promise<SearchGetSearchAddressBatchResponse> {
    const poller = await this.beginGetSearchAddressBatch(batchId, options);
    return poller.pollUntilDone();
  }
  ...
  async beginReverseSearchAddressBatch(
    ...
    PollerLike<
      PollOperationState<SearchReverseSearchAddressBatchResponse>,
      SearchReverseSearchAddressBatchResponse
    >
  > {
    const directSendOperation = async (
  ...
  async beginReverseSearchAddressBatchAndWait(
    ...
    const poller = await this.beginReverseSearchAddressBatch(format, batchRequest, options);
    return poller.pollUntilDone();
  }
   ...
   * @param options The options parameters.
   */
  async beginGetReverseSearchAddressBatch(
    batchId: string,
    options?: SearchGetReverseSearchAddressBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<SearchGetReverseSearchAddressBatchResponse>,
      SearchGetReverseSearchAddressBatchResponse
    >
  > {
    const directSendOperation = async (
   ...
   * @param options The options parameters.
   */
  async beginGetReverseSearchAddressBatchAndWait(
    batchId: string,
    options?: SearchGetReverseSearchAddressBatchOptionalParams
  ): Promise<SearchGetReverseSearchAddressBatchResponse> {
    const poller = await this.beginGetReverseSearchAddressBatch(batchId, options);
    return poller.pollUntilDone();
  }
}

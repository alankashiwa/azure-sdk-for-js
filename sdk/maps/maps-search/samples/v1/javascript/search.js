...
async function main() {
  ...
  // const keyCredential = new AzureKeyCredential(process.env.MAPS_SUBSCRIPTION_KEY);
  // const client = new MapsSearchClient(keyCredential);

  const tokenCredential = new DefaultAzureCredential();
  const client = new MapsSearchClient(tokenCredential, { xMsClientId: process.env.CLIENT_ID });
  ...
  console.log(await client.getSearchAddress("json", "15127 NE 24th Street, Redmond, WA 98052"));

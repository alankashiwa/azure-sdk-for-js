...
/** Defines headers for GeneratedClient_requestRouteMatrix operation. */
export interface GeneratedClientRequestRouteMatrixHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for GeneratedClient_getRouteMatrix operation. */
export interface GeneratedClientGetRouteMatrixHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for GeneratedClient_requestRouteDirectionsBatch operation. */
export interface GeneratedClientRequestRouteDirectionsBatchHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for GeneratedClient_getRouteDirectionsBatch operation. */
...
/** Optional parameters. */
export interface GeneratedClientRequestRouteMatrixOptionalParams
...
/** Optional parameters. */
export interface GeneratedClientGetRouteMatrixOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface GeneratedClientRequestRouteMatrixSyncOptionalParams
  extends coreClient.OperationOptions {
  /** Boolean to indicate whether to execute the request synchronously. If set to true, user will get a 200 response if the request is finished under 120 seconds. Otherwise, user will get a 202 response right away. Please refer to the API description for more details on 202 response. **Supported only for async request**. */
  waitForResults?: boolean;
  /** Specifies whether to return additional travel times using different types of traffic information (none, historic, live) as well as the default best-estimate travel time. */
...
/** Optional parameters. */
export interface GeneratedClientGetRouteDirectionsOptionalParams
  extends coreClient.OperationOptions {
  /** Specifies whether to return additional travel times using different types of traffic information (none, historic, live) as well as the default best-estimate travel time. */
  computeTravelTime?: ComputeTravelTime;
  /** Specifies which of the section types is reported in the route response. <br><br>For example if sectionType = pedestrian the sections which are suited for pedestrians only are returned. Multiple types can be used. The default sectionType refers to the travelMode input. By default travelMode is set to car */
...
/** Optional parameters. */
export interface GeneratedClientGetRouteDirectionsWithAdditionalParametersOptionalParams
  extends coreClient.OperationOptions {
  /** Specifies whether to return additional travel times using different types of traffic information (none, historic, live) as well as the default best-estimate travel time. */
  computeTravelTime?: ComputeTravelTime;
  /** Specifies which of the section types is reported in the route response. <br><br>For example if sectionType = pedestrian the sections which are suited for pedestrians only are returned. Multiple types can be used. The default sectionType refers to the travelMode input. By default travelMode is set to car */
...
/** Optional parameters. */
export interface GeneratedClientGetRouteRangeOptionalParams
  extends coreClient.OperationOptions {
  /** The date and time of departure from the origin point. Departure times apart from now must be specified as a dateTime. When a time zone offset is not specified, it will be assumed to be that of the origin point. The departAt value must be in the future in the date-time format (1996-12-19T16:39:57-08:00). */
  departAt?: Date;
  /** Weight per axle of the vehicle in kg. A value of 0 means that weight restrictions per axle are not considered. */
...
/** Optional parameters. */
export interface GeneratedClientRequestRouteDirectionsBatchOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface GeneratedClientGetRouteDirectionsBatchOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface GeneratedClientRequestRouteDirectionsBatchSyncOptionalParams
  extends coreClient.OperationOptions {}

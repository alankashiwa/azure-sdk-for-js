...
import {
  ...
  RouteMatrixQuery,
  JsonFormat,
  GeneratedClientRequestRouteMatrixOptionalParams,
  GeneratedClientRequestRouteMatrixResponse,
  GeneratedClientGetRouteMatrixOptionalParams,
  GeneratedClientGetRouteMatrixResponse,
  GeneratedClientRequestRouteMatrixSyncOptionalParams,
  GeneratedClientRequestRouteMatrixSyncResponse,
  ResponseFormat,
  GeneratedClientGetRouteDirectionsOptionalParams,
  GeneratedClientGetRouteDirectionsResponse,
  RouteDirectionParameters,
  GeneratedClientGetRouteDirectionsWithAdditionalParametersOptionalParams,
  GeneratedClientGetRouteDirectionsWithAdditionalParametersResponse,
  GeneratedClientGetRouteRangeOptionalParams,
  GeneratedClientGetRouteRangeResponse,
  BatchRequest,
  GeneratedClientRequestRouteDirectionsBatchOptionalParams,
  GeneratedClientRequestRouteDirectionsBatchResponse,
  GeneratedClientGetRouteDirectionsBatchOptionalParams,
  GeneratedClientGetRouteDirectionsBatchResponse,
  GeneratedClientRequestRouteDirectionsBatchSyncOptionalParams,
  GeneratedClientRequestRouteDirectionsBatchSyncResponse
} from "./models";
...
export class GeneratedClient extends GeneratedClientContext {
  ...
  async beginRequestRouteMatrix(
    ...
    options?: GeneratedClientRequestRouteMatrixOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<GeneratedClientRequestRouteMatrixResponse>,
      GeneratedClientRequestRouteMatrixResponse
    >
  > {
    ...
    ): Promise<GeneratedClientRequestRouteMatrixResponse> => {
  ...
  async beginGetRouteMatrix(
    matrixId: string,
    options?: GeneratedClientGetRouteMatrixOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<GeneratedClientGetRouteMatrixResponse>,
      GeneratedClientGetRouteMatrixResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<GeneratedClientGetRouteMatrixResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
  ...
  requestRouteMatrixSync(
    format: JsonFormat,
    routeMatrixQuery: RouteMatrixQuery,
    options?: GeneratedClientRequestRouteMatrixSyncOptionalParams
  ): Promise<GeneratedClientRequestRouteMatrixSyncResponse> {
  ...
  getRouteDirections(
    ...
    routePoints: string,
    options?: GeneratedClientGetRouteDirectionsOptionalParams
  ): Promise<GeneratedClientGetRouteDirectionsResponse> {
    return this.sendOperationRequest(
  ...
  getRouteDirectionsWithAdditionalParameters(
    ...
    options?: GeneratedClientGetRouteDirectionsWithAdditionalParametersOptionalParams
  ): Promise<
    GeneratedClientGetRouteDirectionsWithAdditionalParametersResponse
  > {
    return this.sendOperationRequest(
  ...
  getRouteRange(
    format: ResponseFormat,
    query: number[],
    options?: GeneratedClientGetRouteRangeOptionalParams
  ): Promise<GeneratedClientGetRouteRangeResponse> {
    return this.sendOperationRequest(
  ...
  async beginRequestRouteDirectionsBatch(
    ...
    options?: GeneratedClientRequestRouteDirectionsBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<GeneratedClientRequestRouteDirectionsBatchResponse>,
      GeneratedClientRequestRouteDirectionsBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<GeneratedClientRequestRouteDirectionsBatchResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
  ...
  async beginGetRouteDirectionsBatch(
    batchId: string,
    options?: GeneratedClientGetRouteDirectionsBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<GeneratedClientGetRouteDirectionsBatchResponse>,
      GeneratedClientGetRouteDirectionsBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<GeneratedClientGetRouteDirectionsBatchResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
  ...
  requestRouteDirectionsBatchSync(
    format: JsonFormat,
    routeDirectionsBatchQueries: BatchRequest,
    options?: GeneratedClientRequestRouteDirectionsBatchSyncOptionalParams
  ): Promise<GeneratedClientRequestRouteDirectionsBatchSyncResponse> {
    return this.sendOperationRequest(
      { format, routeDirectionsBatchQueries, options },

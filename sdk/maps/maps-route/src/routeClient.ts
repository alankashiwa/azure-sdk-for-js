...
import {
  RouteClientOptionalParams,
  RouteMatrixQuery,
  JsonFormat,
  RouteClientRequestRouteMatrixOptionalParams,
  RouteClientRequestRouteMatrixResponse,
  RouteClientGetRouteMatrixOptionalParams,
  RouteClientGetRouteMatrixResponse,
  RouteClientRequestRouteMatrixSyncOptionalParams,
  RouteClientRequestRouteMatrixSyncResponse,
  ResponseFormat,
  RouteClientGetRouteDirectionsOptionalParams,
  RouteClientGetRouteDirectionsResponse,
  RouteDirectionParameters,
  RouteClientGetRouteDirectionsWithAdditionalParametersOptionalParams,
  RouteClientGetRouteDirectionsWithAdditionalParametersResponse,
  RouteClientGetRouteRangeOptionalParams,
  RouteClientGetRouteRangeResponse,
  BatchRequest,
  RouteClientRequestRouteDirectionsBatchOptionalParams,
  RouteClientRequestRouteDirectionsBatchResponse,
  RouteClientGetRouteDirectionsBatchOptionalParams,
  RouteClientGetRouteDirectionsBatchResponse,
  RouteClientRequestRouteDirectionsBatchSyncOptionalParams,
  RouteClientRequestRouteDirectionsBatchSyncResponse
} from "./models";
...
export class RouteClient extends RouteClientContext {
  ...
  async beginRequestRouteMatrix(
    ...
    options?: RouteClientRequestRouteMatrixOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<RouteClientRequestRouteMatrixResponse>,
      RouteClientRequestRouteMatrixResponse
    >
  > {
    ...
    ): Promise<RouteClientRequestRouteMatrixResponse> => {
  ...
  async beginRequestRouteMatrixAndWait(
    ...
    const poller = await this.beginRequestRouteMatrix(format, routeMatrixQuery, options);
  ...
  async beginGetRouteMatrix(
    matrixId: string,
    options?: RouteClientGetRouteMatrixOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<RouteClientGetRouteMatrixResponse>,
      RouteClientGetRouteMatrixResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<RouteClientGetRouteMatrixResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
    ...
    const lro = new LroImpl(sendOperation, { matrixId, options }, getRouteMatrixOperationSpec);
    return new LroEngine(lro, {
      resumeFrom: options?.resumeFrom,
      intervalInMs: options?.updateIntervalInMs,
  ...
  requestRouteMatrixSync(
    format: JsonFormat,
    routeMatrixQuery: RouteMatrixQuery,
    options?: RouteClientRequestRouteMatrixSyncOptionalParams
  ): Promise<RouteClientRequestRouteMatrixSyncResponse> {
  ...
  getRouteDirections(
    ...
    routePoints: string,
    options?: RouteClientGetRouteDirectionsOptionalParams
  ): Promise<RouteClientGetRouteDirectionsResponse> {
    return this.sendOperationRequest(
  ...
  getRouteDirectionsWithAdditionalParameters(
    ...
    options?: RouteClientGetRouteDirectionsWithAdditionalParametersOptionalParams
  ): Promise<RouteClientGetRouteDirectionsWithAdditionalParametersResponse> {
    return this.sendOperationRequest(
  ...
  getRouteRange(
    format: ResponseFormat,
    query: number[],
    options?: RouteClientGetRouteRangeOptionalParams
  ): Promise<RouteClientGetRouteRangeResponse> {
    return this.sendOperationRequest({ format, query, options }, getRouteRangeOperationSpec);
  }
  ...
  async beginRequestRouteDirectionsBatch(
    ...
    options?: RouteClientRequestRouteDirectionsBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<RouteClientRequestRouteDirectionsBatchResponse>,
      RouteClientRequestRouteDirectionsBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<RouteClientRequestRouteDirectionsBatchResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
  ...
  async beginGetRouteDirectionsBatch(
    batchId: string,
    options?: RouteClientGetRouteDirectionsBatchOptionalParams
  ): Promise<
    PollerLike<
      PollOperationState<RouteClientGetRouteDirectionsBatchResponse>,
      RouteClientGetRouteDirectionsBatchResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<RouteClientGetRouteDirectionsBatchResponse> => {
      return this.sendOperationRequest(args, spec);
    };
    const sendOperation = async (
      args: coreClient.OperationArguments,
  ...
  requestRouteDirectionsBatchSync(
    format: JsonFormat,
    routeDirectionsBatchQueries: BatchRequest,
    options?: RouteClientRequestRouteDirectionsBatchSyncOptionalParams
  ): Promise<RouteClientRequestRouteDirectionsBatchSyncResponse> {
    return this.sendOperationRequest(
      { format, routeDirectionsBatchQueries, options },
...
const requestRouteMatrixOperationSpec: coreClient.OperationSpec = {
  ...
  headerParameters: [Parameters.contentType, Parameters.accept, Parameters.clientId],
  mediaType: "json",
  serializer
};

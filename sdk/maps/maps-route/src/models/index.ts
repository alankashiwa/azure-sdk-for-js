...
/** Defines headers for RouteClient_requestRouteMatrix operation. */
export interface RouteClientRequestRouteMatrixHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for RouteClient_getRouteMatrix operation. */
export interface RouteClientGetRouteMatrixHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for RouteClient_requestRouteDirectionsBatch operation. */
export interface RouteClientRequestRouteDirectionsBatchHeaders {
  /** New URL to check for the results of the long running process. */
  location?: string;
}

/** Defines headers for RouteClient_getRouteDirectionsBatch operation. */
...
/** Optional parameters. */
export interface RouteClientRequestRouteMatrixSyncOptionalParams
...
/** Optional parameters. */
export interface RouteClientGetRouteDirectionsWithAdditionalParametersOptionalParams
  extends coreClient.OperationOptions {
  /** Specifies whether to return additional travel times using different types of traffic information (none, historic, live) as well as the default best-estimate travel time. */
  computeTravelTime?: ComputeTravelTime;
  /** Specifies which of the section types is reported in the route response. <br><br>For example if sectionType = pedestrian the sections which are suited for pedestrians only are returned. Multiple types can be used. The default sectionType refers to the travelMode input. By default travelMode is set to car */
...
/** Optional parameters. */
export interface RouteClientRequestRouteDirectionsBatchOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface RouteClientGetRouteDirectionsBatchOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface RouteClientRequestRouteDirectionsBatchSyncOptionalParams
  extends coreClient.OperationOptions {}

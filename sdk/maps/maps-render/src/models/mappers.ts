...
export const RenderClientGetMapTileV2Headers: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RenderClientGetMapTileV2Headers",
    modelProperties: {
      contentType: {
...
export const RenderClientGetMapStateTileHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RenderClientGetMapStateTileHeaders",
    modelProperties: {
      contentType: {
        serializedName: "content-type",
        type: {
...
export const RenderClientGetMapStaticImageHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RenderClientGetMapStaticImageHeaders",
    modelProperties: {
      contentType: {
        serializedName: "content-type",
        type: {

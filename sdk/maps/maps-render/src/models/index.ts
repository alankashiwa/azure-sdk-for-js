...
/** Defines headers for RenderClient_getMapTileV2 operation. */
export interface RenderClientGetMapTileV2Headers {
  /** The content-type for the response. */
  contentType?: string;
}

/** Defines headers for RenderClient_getMapStateTile operation. */
export interface RenderClientGetMapStateTileHeaders {
  /** The content-type for the response. */
  contentType?: string;
}

/** Defines headers for RenderClient_getMapStaticImage operation. */
...
/** Optional parameters. */
export interface RenderClientGetCopyrightCaptionOptionalParams
...
/** Optional parameters. */
export interface RenderClientGetCopyrightFromBoundingBoxOptionalParams
  extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface RenderClientGetCopyrightForWorldOptionalParams
  extends coreClient.OperationOptions {
  /** Yes/no value to exclude textual data from response. Only images and country names will be in response. */
  includeText?: IncludeText;
}

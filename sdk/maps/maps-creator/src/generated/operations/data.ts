...
export class DataImpl implements Data {
  ...
  beginUpload(
    ...
    PollerLike<PollOperationState<DataUploadResponse>, DataUploadResponse>
  >;
  /**
   * **Applies to:** see pricing [tiers](https://aka.ms/AzureMapsPricingTier).
   *
  ...
  async beginUpdate(
    ...
    PollerLike<PollOperationState<DataUpdateResponse>, DataUpdateResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
  ...
  download(
    udid: string,
    options?: DataDownloadOptionalParams

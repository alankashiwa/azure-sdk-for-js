...
import { AliasOperations } from "../operationsInterfaces";
...
/** Class containing AliasOperations operations. */
export class AliasOperationsImpl implements AliasOperations {
  private readonly client: CreatorClientContext;

  /**
   * Initialize a new instance of the class AliasOperations class.
   ...
   */
  public list(options?: AliasListOptionalParams): PagedAsyncIterableIterator<Alias> {
  ...
  private async *listPagingPage(options?: AliasListOptionalParams): AsyncIterableIterator<Alias[]> {
  ...
  private async *listPagingAll(options?: AliasListOptionalParams): AsyncIterableIterator<Alias> {
   ...
   * @param options The options parameters.
   */
  private _list(options?: AliasListOptionalParams): Promise<AliasListResponse> {
  ...
  delete(aliasId: string, options?: AliasDeleteOptionalParams): Promise<void> {
    return this.client.sendOperationRequest({ aliasId, options }, deleteOperationSpec);
  }
  ...
  get(aliasId: string, options?: AliasGetOptionalParams): Promise<AliasGetResponse> {
    return this.client.sendOperationRequest({ aliasId, options }, getOperationSpec);
  }
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.AliasListResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

...
import {
  ...
  SpatialEvaluatePointInPolygonOptionalParams,
  SpatialEvaluatePointInPolygonResponse,
...
export class SpatialImpl implements Spatial {
  ...
  getGeofence(
    ...
    return this.client.sendOperationRequest(
      { format, deviceId, udid, position, options },
  ...
  postGeofence(
    ...
    return this.client.sendOperationRequest(
      { format, deviceId, searchGeofenceRequestBody, position, options },
  ...
  postClosestPoint(
    ...
    return this.client.sendOperationRequest(
      { format, closestPointRequestBody, position, options },
  ...
  postPointInPolygon(
    ...
    return this.client.sendOperationRequest(
      { format, pointInPolygonRequestBody, position, options },
   ...
   * @param options The options parameters.
   */
  evaluatePointInPolygon(
    format: JsonFormat,
    udid: string,
    position: Position,
    options?: SpatialEvaluatePointInPolygonOptionalParams
  ): Promise<SpatialEvaluatePointInPolygonResponse> {
    return this.client.sendOperationRequest(
      { format, udid, position, options },
      evaluatePointInPolygonOperationSpec
    );
  }
...
const getGeofenceOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [
    ...
    Parameters.altitude,
    Parameters.userTime,
    Parameters.searchBufferInMeters,
    Parameters.isAsync,
    Parameters.mode
  ],
...
const postBufferOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.BufferResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const getBufferOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.udid1, Parameters.apiVersion1, Parameters.distances],
  urlParameters: [Parameters.geography, Parameters.format],
  headerParameters: [Parameters.accept, Parameters.clientId],
  serializer
};
...
const postPointInPolygonOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PointInPolygonResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
  ...
  queryParameters: [Parameters.apiVersion1, Parameters.latitude, Parameters.longitude],
  urlParameters: [Parameters.geography, Parameters.format],
  headerParameters: [Parameters.accept, Parameters.clientId, Parameters.contentType2],
  mediaType: "json",
  serializer
};
const evaluatePointInPolygonOperationSpec: coreClient.OperationSpec = {
  path: "/spatial/pointInPolygon/{format}",
  httpMethod: "GET",
  responses: {
    200: {
...
const getGreatCircleDistanceOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.GreatCircleDistanceResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

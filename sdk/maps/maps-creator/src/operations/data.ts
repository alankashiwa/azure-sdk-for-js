...
import {
  ...
  DataUploadResponse,
  DataListOptionalParams,
  DataListResponse,
  DataUpdateOptionalParams,
  DataUpdateResponse,
  DataDownloadOptionalParams,
  DataDownloadResponse,
  DataDeleteOptionalParams,
  DataGetOperationOptionalParams,
  DataGetOperationResponse
} from "../models";
...
export class DataImpl implements Data {
  ...
  beginUpload(
    ...
    options?: DataUpload$binaryOptionalParams
  ...
  beginUpload(
    ...
    options?: DataUpload$jsonOptionalParams
  ): Promise<PollerLike<PollOperationState<DataUploadResponse>, DataUploadResponse>>;
  /**
   * **Applies to:** see pricing [tiers](https://aka.ms/AzureMapsPricingTier).
   *
  ...
  async beginUpload(
    ...args:
      ...
      | [DataFormat, "application/json", Record<string, unknown>, DataUpload$jsonOptionalParams?]
  ): Promise<PollerLike<PollOperationState<DataUploadResponse>, DataUploadResponse>> {
    ...
    if (args[1] === "application/octet-stream") {
      operationSpec = upload$binaryOperationSpec;
      operationArguments = {
        dataFormat: args[0],
        contentType: args[1],
      ...
      operationSpec = upload$jsonOperationSpec;
      operationArguments = {
        dataFormat: args[0],
        contentType: args[1],
        uploadContent: args[2],
  ...
  async beginUploadAndWait(
    ...
    if (args[1] === "application/octet-stream") {
      const poller = await this.beginUpload(...args);
  ...
  async beginUpdate(
    ...
    options?: DataUpdateOptionalParams
  ): Promise<PollerLike<PollOperationState<DataUpdateResponse>, DataUpdateResponse>> {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ...
    const lro = new LroImpl(sendOperation, { udid, updateContent, options }, updateOperationSpec);
    return new LroEngine(lro, {
      resumeFrom: options?.resumeFrom,
      intervalInMs: options?.updateIntervalInMs,
      lroResourceLocationConfig: "location"
  ...
  async beginUpdateAndWait(
    ...
    const poller = await this.beginUpdate(udid, updateContent, options);
    return poller.pollUntilDone();
  }
   ...
   * API](https://docs.microsoft.com/en-us/rest/api/maps/data-v2/upload-preview) for use in our [Azure
  ...
  download(udid: string, options?: DataDownloadOptionalParams): Promise<DataDownloadResponse> {
    return this.client.sendOperationRequest({ udid, options }, downloadOperationSpec);
  }
   ...
   * Upload API](https://docs.microsoft.com/en-us/rest/api/maps/data-v2/upload-preview) for use in our
  ...
  delete(udid: string, options?: DataDeleteOptionalParams): Promise<void> {
    return this.client.sendOperationRequest({ udid, options }, deleteOperationSpec);
  }
  ...
  getOperation(
    operationId: string,
    options?: DataGetOperationOptionalParams
  ): Promise<DataGetOperationResponse> {
...
const upload$binaryOperationSpec: coreClient.OperationSpec = {
  path: "/mapData",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.LongRunningOperationResult,
      headersMapper: Mappers.DataUploadHeaders
    },
    201: {
      bodyMapper: Mappers.LongRunningOperationResult,
      headersMapper: Mappers.DataUploadHeaders
  ...
  queryParameters: [Parameters.apiVersion, Parameters.description, Parameters.dataFormat],
...
const upload$jsonOperationSpec: coreClient.OperationSpec = {
  path: "/mapData",
  httpMethod: "POST",
  responses: {
    200: {
  ...
  queryParameters: [Parameters.apiVersion, Parameters.description, Parameters.dataFormat],
  urlParameters: [Parameters.geography],
  headerParameters: [Parameters.accept, Parameters.clientId, Parameters.contentType1],
  mediaType: "json",
  serializer
};
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.MapDataListResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const updateOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.LongRunningOperationResult,
      headersMapper: Mappers.DataUpdateHeaders
    },
    201: {
      bodyMapper: Mappers.LongRunningOperationResult,
      headersMapper: Mappers.DataUpdateHeaders
  ...
  queryParameters: [Parameters.apiVersion, Parameters.description],
  urlParameters: [Parameters.geography, Parameters.udid],
...
const downloadOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      ...
      headersMapper: Mappers.DataDownloadHeaders
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const getOperationOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.LongRunningOperationResult,
      headersMapper: Mappers.DataGetOperationHeaders
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

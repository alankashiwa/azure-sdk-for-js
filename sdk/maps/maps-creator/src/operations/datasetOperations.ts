...
export class DatasetOperationsImpl implements DatasetOperations {
   ...
   */
  public list(options?: DatasetListOptionalParams): PagedAsyncIterableIterator<Dataset> {
  ...
  async beginCreate(
  ...
  ): Promise<PollerLike<PollOperationState<DatasetCreateResponse>, DatasetCreateResponse>> {
    ...
    const lro = new LroImpl(sendOperation, { conversionId, options }, createOperationSpec);
   ...
   * @param options The options parameters.
   */
  private _list(options?: DatasetListOptionalParams): Promise<DatasetListResponse> {
  ...
  get(datasetId: string, options?: DatasetGetOptionalParams): Promise<DatasetGetResponse> {
    return this.client.sendOperationRequest({ datasetId, options }, getOperationSpec);
  }
  ...
  delete(datasetId: string, options?: DatasetDeleteOptionalParams): Promise<void> {
    return this.client.sendOperationRequest({ datasetId, options }, deleteOperationSpec);
  }
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.DatasetListResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

...
import { TilesetOperations } from "../operationsInterfaces";
...
/** Class containing TilesetOperations operations. */
export class TilesetOperationsImpl implements TilesetOperations {
  private readonly client: CreatorClientContext;

  /**
   * Initialize a new instance of the class TilesetOperations class.
   ...
   */
  public list(options?: TilesetListOptionalParams): PagedAsyncIterableIterator<Tileset> {
  ...
  async beginCreate(
  ...
  ): Promise<PollerLike<PollOperationState<TilesetCreateResponse>, TilesetCreateResponse>> {
    ...
    const lro = new LroImpl(sendOperation, { datasetId, options }, createOperationSpec);
   ...
   * @param options The options parameters.
   */
  private _list(options?: TilesetListOptionalParams): Promise<TilesetListResponse> {
  ...
  get(tilesetId: string, options?: TilesetGetOptionalParams): Promise<TilesetGetResponse> {
    return this.client.sendOperationRequest({ tilesetId, options }, getOperationSpec);
  }
  ...
  delete(tilesetId: string, options?: TilesetDeleteOptionalParams): Promise<void> {
    return this.client.sendOperationRequest({ tilesetId, options }, deleteOperationSpec);
  }
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.TilesetListResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

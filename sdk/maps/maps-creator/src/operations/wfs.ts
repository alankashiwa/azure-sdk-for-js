...
import {
  ...
  WfsListConformanceOptionalParams,
  WfsListConformanceResponse,
...
export class WfsImpl implements Wfs {
  ...
  getLandingPage(
    ...
    return this.client.sendOperationRequest({ datasetId, options }, getLandingPageOperationSpec);
  }
  ...
  listConformance(
    datasetId: string,
    options?: WfsListConformanceOptionalParams
  ): Promise<WfsListConformanceResponse> {
    return this.client.sendOperationRequest({ datasetId, options }, listConformanceOperationSpec);
  }
  ...
  getCollections(
    ...
    return this.client.sendOperationRequest({ datasetId, options }, getCollectionsOperationSpec);
  }
...
const getLandingPageOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.LandingPageResult
    },
    default: {
...
const listConformanceOperationSpec: coreClient.OperationSpec = {
  path: "/wfs/datasets/{datasetId}/conformance",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.ConformanceResult
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const getCollectionOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion],
  urlParameters: [Parameters.geography, Parameters.datasetId1, Parameters.collectionId],
  headerParameters: [Parameters.accept, Parameters.clientId],
  serializer
};
const getCollectionDefinitionOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.CollectionDefinition
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }

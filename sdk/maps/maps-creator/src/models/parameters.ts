...
import {
  StyleRules as StyleRulesMapper,
...
export const dataFormat: OperationQueryParameter = {
  parameterPath: "dataFormat",
  mapper: {
...
export const udid: OperationURLParameter = {
  parameterPath: "udid",
  mapper: {
    serializedName: "udid",
    required: true,
...
export const accept2: OperationParameter = {
  parameterPath: "accept",
  mapper: {
    defaultValue: "application/json, application/vnd.geo+json, application/octet-stream",
    isConstant: true,
    serializedName: "Accept",
    type: {
      name: "String"
...
export const udid1: OperationQueryParameter = {
  parameterPath: "udid",
  mapper: {
    serializedName: "udid",
    required: true,
...
export const styleRules: OperationParameter = {
  parameterPath: "styleRules",
  mapper: StyleRulesMapper
};
...
export const featureStates: OperationParameter = {
  parameterPath: "featureStates",
...
export const keyName: OperationQueryParameter = {
...
export const latitude: OperationQueryParameter = {
  parameterPath: ["position", "latitude"],
  mapper: {
    serializedName: "lat",
    required: true,
    type: {
...
export const longitude: OperationQueryParameter = {
  parameterPath: ["position", "longitude"],
  mapper: {
    serializedName: "lon",
    required: true,
    type: {
...
export const altitude: OperationQueryParameter = {
  parameterPath: ["options", "altitude"],
  mapper: {
    serializedName: "z",
    type: {
      name: "Number"
...
export const searchBufferInMeters: OperationQueryParameter = {
  parameterPath: ["options", "searchBufferInMeters"],
  mapper: {
    constraints: {
...
export const boundingBox: OperationQueryParameter = {
  parameterPath: ["options", "boundingBox"],
  mapper: {
    serializedName: "bbox",
    type: {
      name: "Sequence",

...
import {
  ...
  JsonFormat,
  GeneratedClientGetTimezoneByIDOptionalParams,
  GeneratedClientGetTimezoneByIDResponse,
  GeneratedClientGetTimezoneByCoordinatesOptionalParams,
  GeneratedClientGetTimezoneByCoordinatesResponse,
  GeneratedClientGetWindowsTimezoneIdsOptionalParams,
  GeneratedClientGetWindowsTimezoneIdsResponse,
  GeneratedClientGetIanaTimezoneIdsOptionalParams,
  GeneratedClientGetIanaTimezoneIdsResponse,
  GeneratedClientGetIanaVersionOptionalParams,
  GeneratedClientGetIanaVersionResponse,
  GeneratedClientConvertWindowsTimezoneToIanaOptionalParams,
  GeneratedClientConvertWindowsTimezoneToIanaResponse
} from "./models";
...
export class GeneratedClient extends GeneratedClientContext {
  ...
  getTimezoneByID(
    format: JsonFormat,
    timezoneId: string,
    options?: GeneratedClientGetTimezoneByIDOptionalParams
  ): Promise<GeneratedClientGetTimezoneByIDResponse> {
    return this.sendOperationRequest(
      { format, timezoneId, options },
  ...
  getTimezoneByCoordinates(
    format: JsonFormat,
    coordinates: number[],
    options?: GeneratedClientGetTimezoneByCoordinatesOptionalParams
  ): Promise<GeneratedClientGetTimezoneByCoordinatesResponse> {
    return this.sendOperationRequest(
  ...
  getWindowsTimezoneIds(
    format: JsonFormat,
    options?: GeneratedClientGetWindowsTimezoneIdsOptionalParams
  ): Promise<GeneratedClientGetWindowsTimezoneIdsResponse> {
    return this.sendOperationRequest(
      { format, options },
      getWindowsTimezoneIdsOperationSpec
    );
  }
  ...
  getIanaTimezoneIds(
    format: JsonFormat,
    options?: GeneratedClientGetIanaTimezoneIdsOptionalParams
  ): Promise<GeneratedClientGetIanaTimezoneIdsResponse> {
    return this.sendOperationRequest(
      { format, options },
      getIanaTimezoneIdsOperationSpec
    );
  }
  ...
  getIanaVersion(
    format: JsonFormat,
    options?: GeneratedClientGetIanaVersionOptionalParams
  ): Promise<GeneratedClientGetIanaVersionResponse> {
    return this.sendOperationRequest(
      { format, options },
      getIanaVersionOperationSpec
    );
  }
  ...
  convertWindowsTimezoneToIana(
    ...
    options?: GeneratedClientConvertWindowsTimezoneToIanaOptionalParams
  ): Promise<GeneratedClientConvertWindowsTimezoneToIanaResponse> {
    return this.sendOperationRequest(

...
/** Optional parameters. */
export interface GeneratedClientGetDataForPointsOptionalParams
...
/** Optional parameters. */
export interface GeneratedClientPostDataForPointsOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface GeneratedClientGetDataForPolylineOptionalParams
  extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface GeneratedClientPostDataForPolylineOptionalParams
  extends coreClient.OperationOptions {
  /** The samples parameter specifies the number of equally spaced points at which elevation values  should be provided along a polyline path. The number of samples should range from 2 to 2,000. Default value is 10. */
  samples?: number;
}
...
/** Optional parameters. */
export interface GeneratedClientGetDataForBoundingBoxOptionalParams
  extends coreClient.OperationOptions {}
